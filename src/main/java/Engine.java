...
public void start(){
    ...
    if (win) {
        ...
        System.out.println("Введите shoot, чтобы выстрелить или погибнете");
        ...
        if(!answer.equals("shoot")|| i == 5){
            System.out.println("Существо сидевшее напротив, обхватило вашу шею своими длинными пальцами.");
